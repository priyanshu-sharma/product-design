...
def product_creation_task(serialized_data):
    ...
    product_metadata = serialized_data.get("product_metadata", {})
    product_description = serialized_data.get("product_description", None)
    product_dict = product_api.get_or_create_product(product_name, product_type, product_metadata, product_description)
    ...
    for product_detail in product_details:
        handbag_detail_dict = handbag_detail_api.get_or_create_handbag_detail(
            ...
            metadata = product_detail.get("metadata"),
